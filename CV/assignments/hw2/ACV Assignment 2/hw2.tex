...
We performed a real-world experiment by capturing an image of plastic mechanical parts (servo horns) on a plain background (Figure \ref{fig:q1_results}).
\begin{itemize}
    \item \textbf{Setup:} Objects placed on a white table, captured from a top-down perspective.
    \item \textbf{Result:} The naive algorithm counted \textbf{7} objects (distinct shapes). The Watershed algorithm (Figure \ref{fig:q1_watershed}) was required to correctly count \textbf{13} objects, handling the touching and overlapping parts effectively.
\end{itemize}
...
We applied the naive object counting pipeline to a video sequence (\texttt{bonus\_output.mp4}) containing 3--5 objects.
\begin{itemize}
...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \end{bmatrix}
    \end{equation}
    where $\alpha = \cos \phi$ and $\beta = \sin \phi$. We used bilinear interpolation (\texttt{cv2.INTER\_LINEAR}) and edge replication (\texttt{cv2.BORDER\_REPLICATE}) to warp the image.
\end{enumerate}
...
For an image $f(x,y)$ of size $M \times N$, the 2D DFT is defined as:
\begin{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{comparison_q3a.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{comparison_q3b.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{comparison_sat_img1.png}
...
\begin{itemize}
    \item \textbf{Satellite Image:} The compressed image successfully preserves major structural features like coastlines and roads. However, filtering out high frequencies introduces "ringing" artifacts (Gibbs phenomenon) around sharp edges and blurs fine texture (e.g., waves or vegetation).
...
\subsection{Methodology}
Data augmentation increases dataset diversity to improve model robustness. We implemented five types of augmentations:
\begin{itemize}
    ...
    \item \textbf{Shear:} Applying a shear transformation along the X and Y axes to simulate perspective shifts.
\end{itemize}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_resize1.jpg}
        \caption{Resize (Nearest)}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_resize2.jpg}
        \caption{Resize (Bicubic)}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_blur_noise.jpg}
        \caption{Gaussian Blur}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_horizontal_flip.jpg}
        \caption{Horizontal Flip}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_vertical_flip.jpg}
        \caption{Vertical Flip}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_rotation.jpg}
        \caption{Rotation ($30^\circ$)}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_shear_x.jpg}
        \caption{Shear X}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{q4_shear_y.jpg}
        \caption{Shear Y}
    \end{subfigure}
...
\subsection{Bonus: Validity for Face Recognition}
When applying augmentations to a dataset labeled "Face", we must consider if the transformation preserves the label's semantic validity.
\begin{itemize}
